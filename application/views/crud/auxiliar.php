                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_table_auxiliar as $row) { ?>
                                                ...
                                                <td style="text-align: center;"><?php echo $i++; ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('auxiliar/edit'); ?>/<?php echo $row->auxiliar_id; ?>"><button type="button" class="btn btn-warning btn-sm" title="Editar" data-toggle="tooltip"><span class="fas fa-edit" aria-hidden="true"></span></button></a>

                                                            <a href="<?php echo site_url('auxiliar/delete'); ?>/<?php echo $row->auxiliar_id; ?>" class="eliminarPersona btn btn-danger btn-sm" title="Eliminar" data-toggle="tooltip" ><i class="fa fa-trash"></i></a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="exampleModalLabel1">Agregar Bienes:</h4>
                                </div>
