                        ...
                        <div class="row page-titles">
                            <div class="col-md-6 col-8 align-self-center">
                                 <a href="<?php echo site_url('Activos/reportes'); ?>" class="btn btn-info " title="Ir Atras" data-toggle="tooltip" ><i class="fa fas fa-reply"></i> Atras</a>
                                  <br><br>
                                <h4 class="card-title">Reporte por Categorias</h4>                                
                            </div>                           
                        </div>                       
                        <p></p>                       
                        <!-- Step 1 -->     
                <!--       ?php echo form_open('Reportes/etiquetasQr',array('method'=>'POST',  'target' => '_blank')); ?>  -->
                       <?php echo form_open('Reportes/listadoActivos',array('method'=>'POST',  'target' => '_blank')); ?> 
                        <div class="row" >
                           

                             <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="location1">Seleccione una categoria<span class="text-danger"> *</span></label>
                                            <select class="custom-select form-control" id="grupo_id" name="grupo_id" required>
                                                <option value="todos">Todos</option>
                                                        <?php foreach ($grupos as $tp) : ?>
