...
<div class="encabezado">
    ...
    <h4 align="center">LISTADO DE ACTIVOS FIJOS DE LA OFICINA <?php echo $oficina; ?></h4>
</div>
...
<div class="invoice">
    ...
    <table width="100%" class="code">
        ...
        <tbody>            
            <?php foreach ($data_table_activos as $row) { ?>
                <tr align="center">                    
                    ...
                    <td><img src="<?php echo base_url(); ?>public/assets/images/activos/<?php echo $row->imagen;?>"  width="54" /></td>
                </tr>
                <?php 
            } ?>
        </tbody>        
        ...
        <tr>
            ...
            <td align="center" style="width: 30%;" >
                    .........................................................<p></p>      
                    <?php echo $responsable->nombre; ?><p></p>   
                    <b class=""><?php echo 'AUXILIAR DE LA '.$responsable->seccion; ?></b><p></p>      
                    <b><?php echo $firmas[0]['firma']; ?></b>
              
            </td>
            <td align="center" style="width: 30%;">
                    .........................................................<p></p>      
                    <?php echo $encargado->nombre; ?><p></p>   
                    <b class=""><?php echo 'JEFE DE LA '.$encargado->seccion; ?></b><p></p>      
                    <b><?php echo $firmas[0]['firma']; ?></b>
