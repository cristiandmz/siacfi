                    ...
                    <div class="card-body">
                        <div class="row page-titles">
                            <div class="col-md-6 col-8 align-self-center">
                                 <a href="<?php echo site_url('Devolucion/lista'); ?>" class="btn btn-info " title="Ir Atras" data-toggle="tooltip" align="left" ><i class="fa fas fa-reply" ></i> Atras</a>
                                  <br><br>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($solicitud as $row) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('Reportes/actaDevolucion'); ?>/<?php echo $row->detalledev_id  ?>" target="_blank" class=' btn waves-effect waves-light btn btn-danger'><span class="fas fa-file-pdf" aria-hidden="true" style="font-size:32px;"></span></a> 
                                                    </td>
