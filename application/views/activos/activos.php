                                                ...
                                                <tr>
                                                    ...
                                                    <td>   
                                                        ...
                                                        <?php if (($row->estado_act)==1):?>
                                                            <div class="label label-table label-danger">En almacen</div>
                                                        <?php endif ?>
                                                        <?php if (($row->estado_act)==2):?>
                                                            <div class="label label-table label-success">Asignado</div>
                                                       <?php endif ?>
                                                   </td> 
                                                   <td>
                                                    <a href="<?php echo site_url('activos/edit'); ?>/<?php echo $row->activo_id; ?>" class="btn btn-warning btn-sm" title="Editar" data-toggle="tooltip" > <i class="far fa-edit"></i></a>

                                                    <a href="<?php echo site_url('activos/pdf_alta'); ?>/<?php echo $row->activo_id  ?>" class="btn btn-success btn-sm" title="Reporte" data-toggle="tooltip"  target="_blank"><i class="fas fa-file-pdf"></i></a>  
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="recipient-name" class="control-label">Codigo A.F. :</label>
                                ...
                                <div class="form-group">
                                    <div class="card">
                                        ...
                                        <input type="file" id="input-file-now" class="dropify" name="foto_org" data-allowed-file-extensions='["jpg"]' />
                                    </div>
                                </div>
