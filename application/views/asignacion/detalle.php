                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($solicitud as $row) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('Reportes/actaAsignacion'); ?>/<?php echo $row->detalle_id  ?>" target="_blank"><span class="fas fa-file-pdf" aria-hidden="true" style="color:red"></span></a> 
                                                    </td>
