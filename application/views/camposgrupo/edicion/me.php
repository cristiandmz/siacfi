                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="location1">Color :</label>
                                            <input type="text" class="form-control" id="color" name="color" onkeypress="return check_keyModelos(event)" value="<?php echo $datosA->color; ?>" >
                                        </div>
                                    </div>
