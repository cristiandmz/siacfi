                    ...
                    <div class="card-body">
                        <div class="row page-titles">
                            <div class="col-md-6 col-8 align-self-center">
                                <h4 class="card-title">Registro de Localizaciones</h4>                                
                            </div>                           
                        </div>                       
                        <p></p>                       
                        <!-- Step 1 -->                         
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="auxiliar_table" class="table table-bordered table-striped" style="font-size: 14px">
                                        ...
                                        <tbody>
                                            <?php $i=1;?>
                                            <?php foreach ($data_table_unidad as $row) { ?>
                                                <tr>
                                                <td style="text-align: center;"><?php echo $i++; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button  class='userinfo btn waves-effect waves-light btn btn-warning btn-sm' title="Editar" data-toggle="tooltip" data-id="<?php echo $row->oficina_id ?>" ><span class="fas fa-edit" aria-hidden="true" style="color:#ffffff"></span></button>
                                                    
                                                    
                                                        <a href="<?php echo site_url('Oficina/delete'); ?>/<?php echo $row->oficina_id; ?>" class="eliminarPersona btn btn-danger btn-sm" title="Eliminar" data-toggle="tooltip" ><i class="fa fa-trash"></i></a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="exampleModalLabel1">Registrar</h4>
                                </div>
                                <div class="modal-body">
                                   
                                        <?php echo form_open('Oficina/create'); ?>
                                      

                                        <div class="form-group">
                                            <label for="recipient-name" class="control-label">Localización:</label>
                                            <input type="text" class="form-control" id="unidad" name="unidad" onkeypress="return check_keyLetras(event)" onkeyup="mayus(this);" required="">
                                        </div>
