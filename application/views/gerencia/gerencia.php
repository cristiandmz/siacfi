                    ...
                    <div class="card-body">
                        <div class="row page-titles">
                            <div class="col-md-6 col-8 align-self-center">
                                <h4 class="card-title">Registro Nivel Jerarquía</h4>                                
                            </div>                           
                        </div>                       
                        <p></p>                       
                        <!-- Step 1 -->                         
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="auxiliar_table" class="table table-bordered table-striped" style="font-size: 14px">
                                        ...
                                        <tbody>
                                            <?php $i=1;?>
                                            <?php foreach ($data_table_Gerencias as $row) { ?>
                                                <tr>
                                                    <td><?php echo $i++; ?></td>
                                                    <td><?php echo $row->gerencia; ?></td>
                                                    <td><?php echo $row->codGerencia; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button  class='userinfo btn waves-effect waves-light btn btn-warning btn-sm' title="Editar" data-toggle="tooltip" data-id="<?php echo $row->gerencia_id ?>" ><span class="fas fa-edit" aria-hidden="true" style="color:#ffffff"></span></button>
                                                    
                                                  
                                                        <a href="<?php echo site_url('Gerencias/delete'); ?>/<?php echo $row->gerencia_id; ?>" class="eliminarPersona btn btn-danger btn-sm" title="Eliminar" data-toggle="tooltip" ><i class="fa fa-trash"></i></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!--<form action="<?php echo base_url();?>zona_urbana/insertar" method="POST">-->
                                        <?php echo form_open('Gerencias/create'); ?>
                                         <div class="form-group">
                                            <label for="recipient-name" class="control-label">Nivel de Jerarquía:</label>
                                           
                                            <input type="text" class="form-control" id="nombre" name="nombre" onkeypress="return check_keyLetras(event)" required>
                                        </div>  
                                         <div class="form-group">
                                            <label for="recipient-name" class="control-label">Sigla:</label>
                                            
                                            <input type="text" class="form-control" id="codGerencia" name="codGerencia" onkeypress="return check_keyLetras(event)" onkeyup="mayus(this);" required>
                                        </div>
